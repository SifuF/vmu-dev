...
start:
       mov #$a1,ocr         ; oscillation control register
       mov #$09,mcr         ; mode control register
       mov #$80,vccr        ; LCD constrast control register
       clr1 p3int,0         ; port 3 interrupt function control register
       clr1 p1,7            ; port 1 latch
       mov #$ff,p3          ; port 3 latch
...
clearScreen:
       clr1 ocr,5           ; $A1 -> $81 which sets oscillator to 5 MHz to talk to LCD
